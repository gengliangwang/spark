 ...
 * {@link InputPartitionReader} will be created on executors to do the actual reading. So
...
public interface InputPartition<T> extends Serializable {
   ...
   *
   * If this method fails (by throwing an exception), the action would fail and no Spark job would
   * be submitted.
   */
