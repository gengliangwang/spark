...
private[serializer] object KryoSerializer {
  ...
  private lazy val loadableSparkClasses: Seq[Class[_]] = {
    Seq(
      ...
      "org.apache.spark.sql.execution.ui.SparkPlanGraphNode",
      "org.apache.spark.sql.execution.ui.SparkPlanGraphClusterWrapper",
      "org.apache.spark.sql.execution.ui.SparkPlanGraphNodeWrapper",
      "org.apache.spark.sql.execution.ui.SparkPlanGraphEdge",
      "org.apache.spark.sql.execution.ui.SparkPlanGraphWrapper",
      "org.apache.spark.sql.streaming.ui.StateOperatorProgress",
      "org.apache.spark.sql.streaming.ui.SourceProgress",
      "org.apache.spark.sql.streaming.ui.SinkProgress",
      "org.apache.spark.sql.streaming.ui.StreamingQueryProgress",
